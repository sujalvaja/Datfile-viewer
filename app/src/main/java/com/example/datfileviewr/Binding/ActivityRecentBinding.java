...
public  class ActivityRecentBinding implements ViewBinding {
    ...
    private ActivityRecentBinding(RelativeLayout relativeLayout, ImageView imageView, FrameLayout frameLayout, RelativeLayout relativeLayout2, TabLayout tabLayout, ViewPager viewPager) {
            ...
            if (frameLayout != null) {
                ...
                if (relativeLayout != null) {
                    ...
                    if (tabLayout != null) {
                        ...
                        if (viewPager != null) {
                            return new ActivityRecentBinding((RelativeLayout) view, imageView, frameLayout, relativeLayout, tabLayout, viewPager);
                        }
                    }
                }
            }
